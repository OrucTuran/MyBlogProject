...
namespace MyBlogNight.DataAccessLayer.Migrations
{
    ...
    [Migration("20250122205434_mig_Comments_commenterEmail_commentCategory")]
    partial class mig_Comments_commenterEmail_commentCategory
    {
            ...
            modelBuilder.Entity("MyBlogNight.EntityLayer.Concrete.AppUser", b =>
                {
                    ...
                    b.Property<string>("AppUserDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
